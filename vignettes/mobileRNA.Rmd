...
[(Figure 2)](https://github.com/KJeynesCupper/mobileRNA/blob/main/man/figures/mobileRNA_graphic_1.png) 
...
```
<br>
**Figure 1: Comprehensive diagram of complete mobileRNA workflows.**
...
removed from the analysis when the parameters are utilized. Note that, if the 
...
# Quick Start Example of sRNA Analysis to locate the sRNA mobilome in a plant grafting experiment
...
# Advanced Analysis sRNA analysis  
...
methods: distribution of sRNA classes, Principal Component Analysis (PCA) and
a distance matrix. The PCA and heatmap use an unsupervised clustering methods 
which involves an unbiased log2-transformation of the raw counts. This will 
emphasis the clustering to improve visualization. 
<br>
...
which are unique to the treatment and absent in the control (ie. gained).
...
## Mobile RNA Analysis 
We identify candidate mobile RNAs by identifying clusters which are mapped 
...
--type=mRNA \
--idattr=Name \
[outputfile.bam] [annotationfile.gff.gz]
```
