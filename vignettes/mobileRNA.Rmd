...
For utilising baymobil detection algorithm for mRNA data, please install 
[baymobil](https://github.com/mtomtom/baymobil)[@Tomkins2023], 
[bcftools](https://anaconda.org/bioconda/bcftools)[@Danecek2021],
[snpEff](https://anaconda.org/bioconda/snpeff)[@Lu2012]
...
features_plot <- plotRNAfeatures(data = mobile_sRNA,  
                                 annotation = annotation_file)
