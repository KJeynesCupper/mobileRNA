...
```{r, eval=FALSE}
samples <- file.path(system.file("inst/extdata/sRNAseq",package="mobileRNA"))
...
mapRNA(input = "sRNA",
       ...
       condaenv = "/Users/U2093048/miniconda3/envs/ShortStack4",
       mmap = "n")
...
sampleData <- data.frame(sample = c("selfgraft_1", "selfgraft_2", 
                        ...
                        mate1 = c("selfgraft_1_1.fq", "selfgraft_2_1.fq", 
                                  "heterograft_1_1.fq", "heterograft_2_1.fq"))

samples <- file.path(system.file("inst/extdata/mRNAseq",package="mobileRNA"))
output_location <- tempdir()
