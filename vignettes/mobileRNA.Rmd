...
abstract: >
  A growing number of researchers are turning to 
...
<br><br>
```{r, fig.align="centre", echo=FALSE,out.width="800", out.height="750" }
...
For mRNA data, [HISAT2](https://anaconda.org/bioconda/hisat2) (Kim et al., 2015), 
[HTSeq](https://anaconda.org/bioconda/htseq) (Anders 2014), [SAMtools](https://anaconda.org/bioconda/samtools) 
(Danecek et al., 2021) are required within the same Conda environment 
(Anaconda Inc. 2020).
...
## mRNA analysis
This is a quick start analysis for mRNAseq data. 
### 1. Alignment 
...
### 5. Identify Potential Mobile mRNA
...
### Functional analysis for mobile sRNA data
