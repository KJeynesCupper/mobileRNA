...
knitr::kable(sample_distribution$data, caption = "Table of the distribution of small RNA classes within each sample replicate",
...
```{r, echo=FALSE, results='asis', fig.show="hold"}
knitr::kable(consensus_plot$data, caption = "The distribution of the consensus small RNA classes across the analysis.", 
             align = "l", row.names=FALSE)%>%
  kable_styling(font_size = 10)
...
<br>
```{r, echo=FALSE, results='asis', fig.show="hold"}
knitr::kable(head(mobile_sequences), caption = "Head of the dataframe containing the consensus sequences and complementary sequence of candidate mobile small RNAs", align = "l", row.names=FALSE) %>% 
