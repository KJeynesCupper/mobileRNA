...
```{r, message=FALSE, fig.cap=cap9, fig.show="hold", out.width="33%", fig.subcap= c("A","B","C")}
# View plot (only)
...
p10 <- plotHeatmap(mobile_sRNA_sig24, row.names = FALSE)
...
implication of the mobile sRNA. Or to explore the functionality of native 
populations.  
...
Here we will only be overlapping the data with genes, and adding a buffer 
region of 1kb upstream and downstream of the each gene. 
