...
# Introduction
Similarly to sRNAs, messenger RNA (mRNA) molecules have also been believed to 
move systemically throughout plants, and grafting has been a tool to study this. 
Interspecific grafting could lead to the movement of foreign endogenous mRNAs 
from one genotype to another. Here, we describe a pipeline to assist with this 
specific analysis. 
...
the edgeR or DESeq2 method (see function \code[mobileRNA::RNAdifferentialAnalysis()]). The
...
mRNA_edgeR <- RNAdifferentialAnalysis(data = mRNA_data,
                              group = groups,
                              method = "edgeR" )
