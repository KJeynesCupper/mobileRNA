...
#'
#' @param statistical logical; undertake statistical filtering based on the
#' a p-value or adjusted p-value threshold stated by `padj` & `p.value` when
#' `statistical=TRUE`. Default setting `statistical=FALSE`. Requires presence of 
