...
#'
#' @description Load and organise either sRNAseq or mRNAseq alignment results 
#' into a single dataframe containing all experimental replicates specified 
#' where rows represent either a sRNA cluster (ie. sRNA producing-locus) or 
#' gene, respectively. Based on using the mobileRNA pre-processing method. 
#'
#'
#' @details
...
#' [mobileRNA::sRNAmapper()] function. The vector should contain strings 
